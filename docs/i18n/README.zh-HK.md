...
![Version](https://img.shields.io/badge/version-0.3.17-blue.svg) ![License](https://img.shields.io/badge/license-MIT-green.svg)
...
- 多儲存格選中時提供快捷操作，可以執行「複製為 Markdown」或者「複製為 ASCII」
...
6. JSON / JSONL / YAML / TOML / XML 可以點擊鍵名跳返去源碼對應嗰行，並提供焦點態高亮；CSV / TSV 會以表格方式預覽，支援首行首列固定、點擊儲存格定位、焦點態高亮、多選複製快捷操作（「複製為 Markdown」/「複製為 ASCII」）同 `Cmd/Ctrl+C` 複製
